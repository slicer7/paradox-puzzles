      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        ...
        >
          ...
          >
            ...
            A new enigma awaits each month.
          </motion.p>
          ...
          >
            <Button 
              asChild
              size="lg" 
              className="bg-primary text-primary-foreground hover:bg-gold-light font-display text-lg px-8 py-6 glow-gold"
            >
            ...
            <Button 
              ...
              variant="outline" 
              size="lg"
              className="border-primary text-primary hover:bg-primary/10 font-display text-lg px-8 py-6"
            >
