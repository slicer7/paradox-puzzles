          ...
          {items.length === 0 ? (
            ...
            <>
                  ...
                  {items.map((item) => (
                    <div key={item.variantId} className="flex gap-4 p-4 rounded-lg bg-secondary/30 border border-border/50">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="font-display font-semibold text-primary mt-1">{item.price.currencyCode} {parseFloat(item.price.amount).toFixed(2)}</p>
                      </div>
              ...
              <div className="flex-shrink-0 space-y-4 pt-4 border-t border-border bg-card">
                ...
                <Button onClick={handleCheckout} className="w-full bg-primary text-primary-foreground hover:bg-gold-light" size="lg" disabled={items.length === 0 || isLoading || isSyncing}>
